...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const sent = await interaction.reply({ content: '...', withReponse: true, ephemeral: true})
        ...
        await interaction.editReply({content:JSON.stringify(mcstatus, null, 2), ephemeral: true});
    }
}